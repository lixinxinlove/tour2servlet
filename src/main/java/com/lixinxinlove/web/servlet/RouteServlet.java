...
import com.lixinxinlove.service.impl.FavoriteServiceImpl;
import com.lixinxinlove.service.impl.RouteServiceImpl;
...
public class RouteServlet extends BaseServlet {
    ...
    public void pageQuery(HttpServletRequest request, HttpServletResponse response) throws
      ...
      //  rname = new String(rname.getBytes("iso-8859-1"),"utf-8");
       ...
       // PageEntity<Route> pb = routeService.pageQuery(cid, currentPage, pageSize,rname);
        PageEntity<Route> pb = routeService.pageQuery(cid, currentPage, pageSize);
